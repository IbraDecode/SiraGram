...
public final class ActivityExploreBinding implements ViewBinding {
  ...
  private ActivityExploreBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView exploreRecyclerView) {
  ...
  public static ActivityExploreBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.explore_recycler_view;
      RecyclerView exploreRecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (exploreRecyclerView == null) {
        break missingId;
      }

      return new ActivityExploreBinding((LinearLayout) rootView, exploreRecyclerView);
    }
