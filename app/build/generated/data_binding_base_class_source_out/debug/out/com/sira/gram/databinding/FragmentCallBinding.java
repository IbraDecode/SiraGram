...
public final class FragmentCallBinding implements ViewBinding {
  ...
  private FragmentCallBinding(@NonNull FrameLayout rootView,
      @NonNull RecyclerView callRecyclerView) {
    this.rootView = rootView;
    this.callRecyclerView = callRecyclerView;
  }
  ...
  public static FragmentCallBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.call_recycler_view;
      RecyclerView callRecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (callRecyclerView == null) {
        break missingId;
      }

      return new FragmentCallBinding((FrameLayout) rootView, callRecyclerView);
    }
